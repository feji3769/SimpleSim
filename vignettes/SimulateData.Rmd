...
# Introduction
This document goes through the usage of a few of the SimpleSim data simulation functions and lays out how to use the package.
...
Now we are ready to start using the functions. In what follows we will simply catalogue the most useful functions. 


# Blobs
Blobs are just Isotropic Gaussians with varying numbers of centers. To generate eight blobs on a 2d place, each with N samples we can do the following: 
